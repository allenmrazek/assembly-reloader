...
namespace AssemblyReloader.Commands
{
    public class SaveConfigNodeFromCallbacksCommand : ICommand
    {
        ...
        private readonly IFilePathQuery _filePathQuery;
        private readonly string _header;
        public event Action<ConfigNode> OnExecute = delegate { };

        public SaveConfigNodeFromCallbacksCommand([NotNull] string nodeName, [NotNull] IFilePathQuery filePathQuery,
