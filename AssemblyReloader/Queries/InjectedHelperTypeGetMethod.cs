...
{
    public class InjectedHelperTypeGetMethod : IGetMethodDefinitions
    {
        private readonly IGetTypeDefinitions _injectedGetTypeQuery;
        private readonly string _methodName;

        public InjectedHelperTypeGetMethod(IGetTypeDefinitions injectedGetTypeQuery, string methodName)
        {
